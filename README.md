...
The rejection text states that the "submission does not contain sufficient original or substantive scholarly research and is not of interest to arXiv." However, under the assumption that the service reflects the interests of the scientific community, this claim directly contradicts the observed facts: the article's popularity on Zenodo, its verification by four specialists in algebra and analysis who focus on the article's topic, and 44 citations within two months of the preprint's publication.
